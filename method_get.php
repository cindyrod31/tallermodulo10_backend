...
<a href="index.html#section-respuestas">
    ...
    <form action="" method="POST">
        ...
        <button type="submit" name="verificar" class="btn btn-outline-info">Envíar</button> <!-- Se corrigio la ortografia-->
    </form>
    ...
    if (isset($_POST['verificar'])) {
        $nombre = $_POST['nombre']; // se cambio GET por POST para enviar los datos por este metodo
        $apellido = $_POST['apellido'];
        $cedula = $_POST['cc'];// se cambio GET por POST para enviar los datos por este metodo
